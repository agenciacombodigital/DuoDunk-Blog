...
export const metadata: Metadata = {
  ...
  description: `Leia nossa política de privacidade atualizada em ${lastUpdated} para entender como coletamos, usamos e protegemos seus dados.`,
  alternates: {
    canonical: 'https://www.duodunk.com.br/privacidade',
  },
};
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                <Link href="/cookies" className="text-[#00DBFB] hover:text-[#FA007D] underline">
                  Política de Cookies
                </Link>.
              </p>
            </section>
