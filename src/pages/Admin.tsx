      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <Link to="/admin/manual" className="btn-success flex items-center justify-center gap-2">
              <Edit3 className="w-5 h-5" /> Publicação Manual
            </Link>
            <Link to="/admin/rodada-nba" className="btn-success flex items-center justify-center gap-2" style={{ backgroundColor: '#22c55e' }}>
              <Calendar className="w-5 h-5" /> Criar Rodada NBA
            </Link>
