...
export default function Time() {
  ...
  return (
    <>
      <PageMeta
        title={`${team.location} ${team.nickname} - Notícias, Elenco e Estatísticas`}
        description={`Tudo sobre o ${team.name}: elenco, estatísticas, jogos recentes e próximos confrontos. Acompanhe o time na ${team.conference} Conference.`}
        canonicalPath={`/times/${teamSlug}`}
      />
      <div className="min-h-screen bg-white">
        {/* Hero Section */}
        <div 
