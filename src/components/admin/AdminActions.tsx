  ...
  return (
    <div className="bg-gray-900 rounded-xl p-4 md:p-6 border border-gray-800">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4">
        ...
        <button onClick={onProcess} disabled={isLoading} className={`btn-magenta ${ButtonBase}`}><Bot className="w-4 h-4" /> Processar IA</button>
        <button 
        ...
        <Link to="/admin/rodada-nba" className={`bg-yellow-500 hover:bg-yellow-600 text-black ${ButtonBase}`}><Calendar className="w-4 h-4" /> Rodada NBA</Link>
