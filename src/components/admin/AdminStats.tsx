...
export default function AdminStats({ pendingProcessingCount, autoApprovedCount, pendingApprovalCount, publishedCount, rateLimitedCount }: AdminStatsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
      ...
      <div className="bg-gray-900 rounded-xl p-6 border border-gray-800"><p className="text-gray-400 text-sm mb-1">Rate Limit</p><p className="text-3xl font-bold text-red-400">{rateLimitedCount}</p></div>
    </div>
  );
}