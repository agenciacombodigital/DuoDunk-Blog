    ...
    <div className="bg-gray-900 rounded-xl p-4 md:p-6 border border-gray-800">
      ...
      <div className="space-y-2">
        {articles.map((article) => (
          <div key={article.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 bg-gray-800 rounded-lg border border-gray-700 hover:border-green-700/50 transition-colors">
